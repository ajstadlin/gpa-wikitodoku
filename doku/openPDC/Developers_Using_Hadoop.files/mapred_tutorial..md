...
<script type="text/javascript" src="/static/js/analytics.js"></scri
...
pt>
<script type="text/javascript">archive_analytics.values.server_name="wwwb-app13.us.archive.org";archive_analytics.values.server_ms=966;</script>
...
var wbPrefix = "/web/";
var wbCurrentUrl = "http://hadoop.apache.org/docs/r0.20.2/mapred_tutorial.html";
...
<div id="wm-ipp-inside">
   ...
   <td class="c">
       ...
       <form target="_top" method="get" action="/web/form-submit.jsp" name="wmtb" id="wmtb"><input type="text" name="url" id="wmtbURL" value="http://hadoop.apache.org/docs/r0.20.2/mapred_tutorial.html" style="width:400px;" onfocus="this.focus();this.select();" /><input type="hidden" name="type" value="replay" /><input type="hidden" name="date" value="20130201075045" /><input type="submit" value="Go" /><span id="wm_tb_options" style="display:block;"></span></form>
       </td>
        ...
        <td class="f" nowrap="nowrap">
           ...
           <tr class="d">
               <td class="b" nowrap="nowrap">
                   ...
                   <a href="/web/20130123091615/http://hadoop.apache.org/docs/r0.20.2/mapred_tutorial.html" title="9:16:15 Jan 23, 2013"><img src="/static/images/toolbar/wm_tb_prv_on.png" alt="Previous capture" width="14" height="16" border="0" /></a>
       ...
       <tr>
       <td class="s">
           <a class="t" href="/web/20130201075045*/http://hadoop.apache.org/docs/r0.20.2/mapred_tutorial.html" title="See a list of every capture for this URL">39 captures</a>
           <div class="r" title="Timespan for captures of this URL">15 Sep 12 - 16 Sep 15</div>
       </td>
       <td class="k">
...
<a href="/web/20130201075045/http://www.apache.org/">Apache</a> &gt; <a href="/web/20130201075045/http://hadoop.apache.org/">Hadoop</a> &gt; <a href="/web/20130201075045/http://hadoop.apache.org/core/">Core</a><script src="skin/breadcrumbs.js" language="JavaScript" type="text/javascript"></script>
</div>
<!--+
    |header
    +-->
...
<!--+
    ...
    +-->
<div class="grouplogo">
<a href="/web/20130201075045/http://hadoop.apache.org/"><img class="logoImage" alt="Hadoop" src="images/hadoop-logo.jpg" title="Apache Hadoop"></a>
</div>
<!--+
    |end group logo
    +-->
...
<a href="/web/20130201075045/http://hadoop.apache.org/core/"><img class="logoImage" alt="Hadoop" src="images/core-logo.gif" title="Scalable Computing Platform"></a>
</div>
<!--+
    |end Project Logo
    +-->
<!--+
    ...
    +-->
<div class="searchbox">
<form action="/web/20130201075045/http://www.google.com/search" method="get" class="roundtopsmall">
...
<ul id="tabs">
<li>
<a class="unselected" href="/web/20130201075045/http://hadoop.apache.org/core/">Project</a>
</li>
<li>
<a class="unselected" href="/web/20130201075045/http://wiki.apache.org/hadoop">Wiki</a>
</li>
<li class="current">
...
<div class="menuitem">
<a href="/web/20130201075045/http://wiki.apache.org/hadoop/">Wiki</a>
</div>
<div class="menuitem">
<a href="/web/20130201075045/http://wiki.apache.org/hadoop/FAQ">FAQ</a>
</div>
<div class="menuitem">
...
<ul class="minitoc">
<li>
<a href="#Source+Code-N10FD0">Source Code</a>
</li>
<li>
...
<a href="api/org/apache/hadoop/mapred/pipes/package-summary.html">
          Hadoop Pipes</a> is a <a href="/web/20130201075045/http://www.swig.org/">SWIG</a>-
...
<tr>
<td colspan="1" rowspan="1"><span class="codefrag">mapred.task.maxvmem</span></td><td colspan="1" rowspan="1">int</td>
            <td colspan="1" rowspan="1">A number, in bytes, that represents the maximum Virtual Memory
...
<tr>
<td colspan="1" rowspan="1">mapred.task.maxpmem</td><td colspan="1" rowspan="1">int</td>
            <td colspan="1" rowspan="1">A number, in bytes, that represents the maximum RAM task-limit
...
<a name="N10906"></a><a name="Map+Parameters"></a>
...
<a name="N10972"></a><a name="Shuffle%2FReduce+Parameters"></a>
...
<a name="N109ED"></a><a name="Directory+Structure"></a>
...
<a name="N10A5C"></a><a name="Task+JVM+Reuse"></a>
...
<p>The <a href="#DistributedCache">DistributedCache</a> can also be used
        ...
        <a href="/web/20130201075045/http://java.sun.com/javase/6/docs/api/java/lang/System.html#loadLibrary(java.lang.String)">
        System.loadLibrary</a> or 
        <a href="/web/20130201075045/http://java.sun.com/javase/6/docs/api/java/lang/System.html#load(java.lang.String)">
...
<a name="N10B45"></a><a name="Job+Submission+and+Monitoring"></a>
...
<a name="N10BA5"></a><a name="Job+Control"></a>
<h4>Job Control</h4>
...
<a name="N10BCF"></a><a name="Job+Input"></a>
...
<a name="N10C36"></a><a name="InputSplit"></a>
<h4>InputSplit</h4>
<p>
...
<a href="api/org/apache/hadoop/mapred/FileSplit.html">
          ...
          logical split.</p>
<a name="N10C5B"></a><a name="RecordReader"></a>
<h4>RecordReader</h4>
<p>
...
<a name="N10C7E"></a><a name="Job+Output"></a>
...
<a name="N10CA7"></a><a name="OutputCommitter"></a>
...
<a name="N10CD7"></a><a name="Task+Side-Effect+Files"></a>
...
<a name="N10D25"></a><a name="RecordWriter"></a>
<h4>RecordWriter</h4>
<p>
...
<a name="N10D3C"></a><a name="Other+Useful+Features"></a>
<h3 class="h4">Other Useful Features</h3>
<a name="N10D42"></a><a name="Submitting+Jobs+to+Queues"></a>
...
<p>A job defines the queue it needs to be submitted to through the
          ...
          queue.</p>
<a name="N10D60"></a><a name="Counters"></a>
<h4>Counters</h4>
<p>
...
<a name="N10D8F"></a><a name="DistributedCache"></a>
...
<a name="N10E44"></a><a name="IsolationRunner"></a>
...
<a name="N10E77"></a><a name="Profiling"></a>
<h4>Profiling</h4>
...
<a name="N10EAB"></a><a name="Debugging"></a>
<h4>Debugging</h4>
...
<p> In the following sections we discuss how to submit a debug script
          ...
          the framework.</p>
<a name="N10EB7"></a><a name="How+to+distribute+the+script+file%3A"></a>
...
<a name="N10ECB"></a><a name="How+to+submit+the+script%3A"></a>
...
<a name="N10EF9"></a><a name="Default+Behavior%3A"></a>
...
<a name="N10F04"></a><a name="JobControl"></a>
<h4>JobControl</h4>
<p>
<a href="api/org/apache/hadoop/mapred/jobcontrol/package-summary.html">
          JobControl</a> is a utility which encapsulates a set of Map/Reduce jobs
          and their dependencies.</p>
<a name="N10F11"></a><a name="Data+Compression"></a>
...
<p>Hadoop Map/Reduce provides facilities for the application-writer to
          ...
          <a href="/web/20130201075045/http://www.zlib.net/">zlib</a> compression 
          algorithm. The <a href="/web/20130201075045/http://www.gzip.org/">gzip</a> file format is also
          supported.</p>
...
<a name="N10F2D"></a><a name="Intermediate+Outputs"></a>
...
<a name="N10F42"></a><a name="Job+Outputs"></a>
<h5>Job Outputs</h5>
...
<a name="N10F6F"></a><a name="Skipping+Bad+Records"></a>
...
<a name="N10FB6"></a><a name="Example%3A+WordCount+v2.0"></a>
...
<a name="N10FD0"></a><a name="Source+Code-N10FD0"></a>
<h3 class="h4">Source Code</h3>
<table class="ForrestTable" cellspacing="1" cellpadding="4">
...
<a name="N11732"></a><a name="Sample+Runs"></a>
...
<a name="N11806"></a><a name="Highlights"></a>
...
<div class="copyright">
        Copyright &copy;
         2008 <a href="/web/20130201075045/http://www.apache.org/licenses/">The Apache Software Foundation.</a>
</div>
<!--+
    |end bottomstrip
    +-->
